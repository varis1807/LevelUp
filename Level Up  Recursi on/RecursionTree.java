...
public class RecursionTree {
    ...
    public static void coinchange() {
        ...
        // System.out.println(singlePermutation(coins, tar, vis, asf));
    ...
    // public static int queenCombination2D_sub(int tnb, int bno, int tnq, int qpsf,
    // String asf) {
    // if (qpsf > tnq || bno > tnb) {
    // if (qpsf > tnq) {
    // System.out.println(asf);
    ...
    // public static int queenPermutation2D_sub(int tnb, int bno, int tnq, int qpsf,
    // boolean[] vis, String asf) {
    // if (qpsf > tnq || bno > tnb) {
    // if (qpsf > tnq) {
    // System.out.println(asf);
    // return 1;
